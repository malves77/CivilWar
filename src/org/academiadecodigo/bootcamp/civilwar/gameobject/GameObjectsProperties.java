...
public class GameObjectsProperties {
    ...
    public static final int ENEMY_POWER = 5;
    public static final int ENEMY_CHANGEDIRECTIONLEVEL = 8;

    public static final int WEAPON_WIDTH = 20;
    public static final int WEAPON_HEIGHT = 20;
